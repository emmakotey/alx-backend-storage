...
"""
This module provides a get_page function that retrieves the content of a URL and caches it for a certain amount of time.
"""
...
def cache(expiration_time: int) -> callable:
    """
    A decorator that caches the result of a function for a certain amount of time and tracks how many times the function has been called.
    ...
    def decorator(func: callable) -> callable:
        ...
        def wrapper(*args, **kwargs):
            url = args[0]
            if url in cache_dict and time.time() - cache_dict[url]["time"] < expiration_time:
